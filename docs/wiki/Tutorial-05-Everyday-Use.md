...
毎セッション最初に Claude にこう伝えると、自発的に GER-RAG を使ってくれます:
...
GER-RAG は **「使い込むほど育つ」** タイプの道具です。最初は実感薄いですが、ある日「これすごく自分っぽい返事してくれてる」という瞬間が来ます。
...
- 物理アナロジーで遊ぶ: [Four-Layer Philosophy](Reflections-Four-Layer-Philosophy.md)
- 他の使い方ガイド:
