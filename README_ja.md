...
設計仕様と初期計画は [`specs/001-ger-rag-core/`](specs/001-ger-rag-core/) と [`plan.md`](plan.md) に。命名の履歴（GER-RAG → GaOTTT）は [`docs/maintainers/rename-to-gaottt-plan.md`](docs/maintainers/rename-to-gaottt-plan.md) に記録されています。
